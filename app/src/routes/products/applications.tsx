// /products/applications — the catalog grouped by application.
  ...
  return (
    <>
      <header className="pc-head">
        <h1>Applications</h1>
        <p className="pc-sub">Published models, grouped by the application that consumes them.</p>
      </header>
      <input
        className="pc-search"
        value={query}
